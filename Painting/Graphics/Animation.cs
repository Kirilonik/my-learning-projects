...
namespace GraphicsProject
{
    ...
    {
        public static Dictionary<string, AnimationStates> StringToState = new Dictionary<string, AnimationStates>() { { "idle", AnimationStates.idle }, { "run", AnimationStates.run }, { "walk", AnimationStates.walk }, };
